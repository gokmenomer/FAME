function output = matrix_fuzzification_layer(x, learnable_parameters, number_of_rule, number_inputs, mbs)
...
% If learnable_parameters has leftmost_center field, calculate gauss2mf
if isfield(learnable_parameters, 'leftmost_center')
